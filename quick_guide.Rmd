...
<div class="tip-box">
<strong>Student tip:</strong> When you feel lost, start by going back to the course website. It is much easier than digging through old files or trying to remember where something was posted.
</div>
...
<strong>Do not panic:</strong> GitHub is confusing at first for almost everyone. Focus on the basic cycle: save, commit, push, and check GitHub.
</div>
...
Try not to rely only on the Console. Save your code in scripts of R Markdown documents so you can rerun it later. Your future self will thank you!
...
<div class="tip-box">
<strong>Best troubleshooting habit:</strong> Read the first error message carefully. The first error is usually more helpful than the last one.
</div>
